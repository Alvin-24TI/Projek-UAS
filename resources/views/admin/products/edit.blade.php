            ...
            <div class="card-body">
                <form action="{{ route('admin.products.update', $product) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="jobdesc" id="jobdesc" class="form-control @error('jobdesc') is-invalid @enderror" rows="6" placeholder="Masukkan deskripsi detail produk, spesifikasi, features, dll...">{{ old('jobdesc', $product->jobdesc) }}</textarea>
                        @error('jobdesc')
                        <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
